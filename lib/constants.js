  ...
  education: [
    {
      ...
      degree: "PhD",
      fieldOfStudy: "Researcher and Academic Staff",
      dates: "12/2015 — 08/2019",
      city: "Aarhus, Denmark",
...
export const initialStyles = {
  ...
  sectionTitle: { size: 1.0, bold: true, italic: false, color: '#666666', uppercase: true, fontFamily: fonts[0].value },
