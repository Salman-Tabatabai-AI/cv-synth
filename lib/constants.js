...
export const fonts = [
  ...
  { name: 'Playfair', value: 'var(--font-playfair), serif' },
];
...
export const initialStyles = {
  ...
  name: {
    ...
    fontFamily: fonts[0].value, case: 'capitalize'
  },
  ...
  contactInfo: {
    size: 0.9, bold: false, italic: false, color: '#888888',
    fontFamily: fonts[0].value, case: 'none'
  },
